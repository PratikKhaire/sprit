...
const MessageSection = () => {
  useGSAP(() => {
    ...
    const newFristMsgSplit = new SplitText('.first-message', {
      type: 'word',
    });
    ...
    const paragaphTl = gsap.timeline({
      scrollTrigger:{
        trigger:'.message-content p',
        start:'top center',
      },
    });
    paragaphTl.from(paragraphSplit.words,{
      yPercent:300,
      rotate: 3,
      ease:'power1.inOut',
      duration:1,
      ...
      <div className="container mx-auto flex-center py-28 relative">
        <div className="w-full h-full">
          <div className="msg-wrapper">
            ...
            <div style={{ clipPath: 'polygon(0 0, 0 19%, 0 100%, 0 100%)' }} className=" msg-text-scroll">
